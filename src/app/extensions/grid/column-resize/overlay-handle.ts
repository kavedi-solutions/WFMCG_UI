...
import { ColumnResize, ColumnResizeNotifierSource, HeaderRowEventDispatcher, ResizeOverlayHandle, ResizeRef } from '../../column-resize';
...
export class MatColumnResizeOverlayHandle extends ResizeOverlayHandle {
  ...
  protected override updateResizeActive(active: boolean): void {
    ...
    this.resizeRef.overlayRef.updateSize({
      height: active
        ? (this.columnResize as unknown as AbstractMatColumnResize).getTableHeight()
